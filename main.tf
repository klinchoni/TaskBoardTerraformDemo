terraform {
  ...
  backend "azurerm" {
    ...
    storage_account_name = "tbstorageklinchoni"
    container_name       = "tbcontainerklinchoni"
...
provider "azurerm" {
  ...
  subscription_id = "444ed881-7db1-47e2-8274-f08970569b64"
}
...
resource "azurerm_resource_group" "arg" {
  name     = "${var.resource_group_name}_${random_integer.random.result}"
